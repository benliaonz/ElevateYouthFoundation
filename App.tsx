        ...
        <section className="bg-indigo-950 py-24 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-indigo-200 text-xl mb-12 max-w-2xl mx-auto leading-relaxed opacity-80">
              Every young person has a story waiting to be written. Your support provides the ink and the pages for Kiwi youth.
            </p>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
              ...
              <a href="#contact" className="text-white font-bold hover:text-indigo-300 transition-colors flex items-center">
